...
public class EasyDialog
{
    ...
    private void initDialog(final Context context)
    {
        ...
        View dialogView = layoutInflater.inflate(com.michael.easydialog.R.layout.layout_dialog, null);
        ...
        rlOutsideBackground = (RelativeLayout) dialogView.findViewById(com.michael.easydialog.R.id.rlOutsideBackground);
        setTouchOutsideDismiss(true);
        ivTriangle = (ImageView) dialogView.findViewById(com.michael.easydialog.R.id.ivTriangle);
        llContent = (LinearLayout) dialogView.findViewById(com.michael.easydialog.R.id.llContent);
    ...
    public EasyDialog setGravity(int gravity)
    {
        ...
        {
            case GRAVITY_BOTTOM:
                ivTriangle.setBackgroundResource(com.michael.easydialog.R.drawable.triangle_bottom);
                break;
            case GRAVITY_TOP:
                ivTriangle.setBackgroundResource(com.michael.easydialog.R.drawable.triangle_top);
                break;
            case GRAVITY_LEFT:
                ivTriangle.setBackgroundResource(com.michael.easydialog.R.drawable.triangle_left);
                break;
            case GRAVITY_RIGHT:
                ivTriangle.setBackgroundResource(com.michael.easydialog.R.drawable.triangle_right);
                break;
        }
        llContent.setBackgroundResource(com.michael.easydialog.R.drawable.round_corner_bg);
    ...
    public EasyDialog setBackgroundColor(int color)
    {
        ...
        GradientDrawable shapeTriangle = (GradientDrawable) (((RotateDrawable) drawableTriangle.findDrawableByLayerId(com.michael.easydialog.R.id.shape_id)).getDrawable());
    ...
    {
        return rlOutsideBackground.findViewById(com.michael.easydialog.R.id.rlParentForAnimate);
    }
    ...
    private EasyDialog setAnimationTranslation(boolean isShow, int direction, int duration, float... values)
    {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(rlOutsideBackground.findViewById(com.michael.easydialog.R.id.rlParentForAnimate), propertyName, values)
    ...
    {
        ObjectAnimator animator = ObjectAnimator.ofFloat(rlOutsideBackground.findViewById(com.michael.easydialog.R.id.rlParentForAnimate), "alpha", values).setDuration(duration);
        if (isShow)
        {
            objectAnimatorsForDialogShow.add(animator);
        } else
